...
class PayPalStandardBase(Model):
    ...
    def verify(self):
        ...
        """
        from league.models import PayPalAccount
        ...
        if not self.flag:
            if self.is_transaction():
                ...
                paypal_accounts = list(PayPalAccount.objects.values_list('receiver_email', flat=True)) + list(PayPalAccount.objects.values_list('secondary_email', flat=True))#['jayson315@gmail.com']
                if self.receiver_email not in paypal_accounts:
